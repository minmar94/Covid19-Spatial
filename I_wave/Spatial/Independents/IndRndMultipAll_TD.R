...
stan_Multip1 <- stan_model("IndRnd_MultipAll.stan")
stan_Multip2 <- stan_model("IndRnd2_MultipAll.stan")
...
{
  list(# Richards
    logr = rnorm(Nreg, log(ySums)-logE, .11), 
...
save.image(file="WS/IndRndMultipAll_TrueData.RData")
